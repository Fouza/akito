...
const Profile: React.FC<ProfileProps> = ({ name }) => {
  ...
  async function submitUpdate() {
    ...
    await axios
      .put(
        `http://c4216fbecb77.ngrok.io/api/service/user/updateRequestSign/${id}`,
        {
          username: username,
          email: email,
          password: pwd,
  ...
  async function submitUpdatePassword() {
    ...
    await axios
      .put(
        `http://c4216fbecb77.ngrok.io/api/service/user/detailsUser/${id}/updatePassword`,
        {
          oldPassword: oldPwd,
          newPassword: pwd,
        },
  ...
  async function getFitness() {
    ...
    await axios
      .get(
        `http://c4216fbecb77.ngrok.io/api/service/user/getCurrent/${localStorage.getItem(
          "id"
        )}`,
        config
      )
