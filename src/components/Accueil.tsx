...
const Accueil: React.FC<AccueilProps> = ({ name }) => {
  ...
  async function getCategories() {
    ...
    await axios
      .get(
        "http://c4216fbecb77.ngrok.io/api/service/categorieExercise/listCategoriesExercises",
        {
          headers: {
    ...
    await axios
      .get(
        "http://c4216fbecb77.ngrok.io/api/service/categoriesFood/listCategoriesFood",
        {
          headers: {
            Accept: "application/json",
            "Access-Control-Allow-Headers":
  ...
  async function getListeExercices() {
    ...
    await axios
      .get("http://c4216fbecb77.ngrok.io/api/service/exercise/listeExercises", {
        headers: {
          Accept: "application/json",
          "Access-Control-Allow-Headers":
            "Origin, X-Requested-With, Content-Type, Accept",
  ...
  async function searchExoCat() {
    await axios
      .get(
        `http://c4216fbecb77.ngrok.io/api/service/exercise/listeExercisesByCategory?category=${exoCat}`,
        {
          headers: {
  ...
  async function searchExoKey() {
    await axios
      .get(
        `http://c4216fbecb77.ngrok.io/api/service/exercise/listeExercisesByKeyWord?keyword=${exoKey}`,
        {
          headers: {
            //Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function searchExoCal() {
    await axios
      .get(
        `http://c4216fbecb77.ngrok.io/api/service/exercise/listeExercisesByCalories?from=${exoCalFrom}&to=${exoCalTo}`,
        {
          headers: {
            //Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function getListeFood() {
    await axios
      .get("http://c4216fbecb77.ngrok.io/api/service/food/listeFood", {
        headers: {
          Accept: "application/json",
          "Access-Control-Allow-Headers":
            "Origin, X-Requested-With, Content-Type, Accept",
  ...
  async function searchFoodCat() {
    await axios
      .get(
        `http://c4216fbecb77.ngrok.io/api/service/food/listeFoodByCategory?category=${foodCat}`,
        {
          headers: {
            //Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function searchFoodKey() {
    await axios
      .get(
        `http://c4216fbecb77.ngrok.io/api/service/food/listeFoodByKeyWord?keyword=${foodKey}`,
        {
          headers: {
            //Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function searchFoodCal() {
    await axios
      .get(
        `http://c4216fbecb77.ngrok.io/api/service/food/listeFoodCaloriesBetween?from=${parseFloat(
          foodCalFrom
  ...
  async function ajouterExo() {
    ...
    await axios
      .post(
        `http://c4216fbecb77.ngrok.io/api/service/user/${id}/fitnessDetails/addExercise/${addedExo.id}`,
        {
          // idE: addedExo.id,
  ...
  async function ajouterFood() {
    ...
    await axios
      .post(
        `http://c4216fbecb77.ngrok.io/api/service/user/${id}/fitnessDetails/addFood/${addedFood.id}`,
        {},
        config
      )
      .then((res) => {
